  ...
  class Traversal {
    ...
    _traverse (node, context) {
      ...
      if (instanceTypeUtil.isNode(node)) {
        if (this.acceptCallback.call(this, node)) {
          this.callback.call(this, node, context);
          this.numNodes++;
        } else if (this.denyCallback) {
          this.denyCallback.call(this, node, context);
        }

        if (this.recurseCallback.call(this, node)) {
          this.level++;
    ...
    /**
     * Returns the current depth/level being traversed.
     *
     * @returns {Integer}
     */
    getLevel () {
    ...
    /**
     * Returns the number of nodes which has been processed.
     *
     * @returns {Integer}
     */
    getNumNodes () {
